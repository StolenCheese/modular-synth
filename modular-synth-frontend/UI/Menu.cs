...
internal class Menu : Interactable
{
    ...
    public void LoadContent()
    {
        ...
        ActiveButtons.Add(new ModuleSpawnButton(moduleTexture, new Vector2(100, 10),"TestModule", "TestModule_ui"));
        ActiveButtons.Add(new ModuleSpawnButton(moduleTexture, new Vector2(100+moduleTexture.Width+gapBetweenModules, 10),"TestModule2", "TestModule2_ui"));
    }
