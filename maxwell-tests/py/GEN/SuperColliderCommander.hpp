...
class SuperColliderCommander : ServerSocket{
    ...
    std::future<osc::ReceivedMessage> quit();
    ...
    std::future<osc::ReceivedMessage> s_new(std::string definition, int synth, int action, int target, std::vector<std::tuple<std::variant<int ,  std::string>, std::variant<float ,  int ,  std::string>>> control);
    ...
    std::future<osc::ReceivedMessage> s_getn(int synth, std::vector<std::tuple<std::variant<int ,  std::string>, int>> control);
    ...
    std::future<osc::ReceivedMessage> p_new(std::vector<std::tuple<int, int, int>> group);
         ...
         //:param:node: - node ID    
    void g_head(std::vector<std::tuple<int, int>> group);
         ...
         //:param:group: - group ID
         //:param:node: - node ID    
    void g_tail(std::vector<std::tuple<int, int>> group);
