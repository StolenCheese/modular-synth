...
internal class Menu : Interactable
{
	...
	public void LoadContent()
	{
		...
		activeButtons.Add(new ModuleSpawnButton(new Vector2(120, 10), SectionDefManager.LoadSectionDef("brownnoise-ui")));
		activeButtons.Add(new ModuleSpawnButton(new Vector2(120 + (moduleTexture.Width + GAPBETWEENMODULES), 10), SectionDefManager.LoadSectionDef("brownnoise-ui")));
		activeButtons.Add(new ModuleSpawnButton(new Vector2(120 + 2 * (moduleTexture.Width + GAPBETWEENMODULES), 10), SectionDefManager.LoadSectionDef("brownnoise-ui")));
